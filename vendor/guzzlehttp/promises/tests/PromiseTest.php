...
class PromiseTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCancelsChildPromises()
    {
        ...
        $p1 = new Promise(
            null, function () use (&$called1) {
            $called1 = true;
        }
        );
        $p2 = new Promise(
            null, function () use (&$called2) {
            $called2 = true;
        }
        );
        $p3 = new Promise(
            null, function () use (&$called3) {
            $called3 = true;
        }
        );
        $p4 = $p2->then(
